...
//*# Library Name   : ts1n28hpcphvtb320x36m4s (user specify : TS1N28HPCPHVTB320X36M4S)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/06/05, 17:08:17										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB320X36M4S (
            CLK, CEB, WEB,
            A, D,
            Q);

parameter numWord = 320;
parameter numRow = 80;
parameter numCM = 4;
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB320X36M4S_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB320X36M4S_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.4207;
    specparam tCKH = 0.1023;
    specparam tCKL = 0.1430;
    ...
    specparam tDS = 0.0883;
    specparam tDH = 0.0611;
    specparam tCD = 0.2959;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2959;
`else    
    specparam tHOLD = 0.2352;
`endif    
