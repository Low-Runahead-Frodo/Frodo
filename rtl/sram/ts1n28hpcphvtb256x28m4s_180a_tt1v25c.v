...
//*# Library Name   : ts1n28hpcphvtb256x28m4s (user specify : TS1N28HPCPHVTB256X28M4S)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/06/05, 17:06:51										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPHVTB256X28M4S (
            CLK, CEB, WEB,
            A, D,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB256X28M4S_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB256X28M4S_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.4167;
    specparam tCKH = 0.1023;
    specparam tCKL = 0.1431;
    specparam tCS = 0.1373;
    specparam tCH = 0.0358;
    specparam tWS = 0.1193;
    specparam tWH = 0.0385;
    specparam tAS = 0.1149;
    specparam tAH = 0.0406;
    specparam tDS = 0.0914;
    specparam tDH = 0.0571;
    specparam tCD = 0.2881;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2881;
`else    
    specparam tHOLD = 0.2297;
`endif    
