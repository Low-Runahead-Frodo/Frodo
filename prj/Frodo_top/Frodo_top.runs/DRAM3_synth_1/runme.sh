...
HD_PWD='C:/Users/Lenovo/Desktop/Frodo/prj/Frodo_top/Frodo_top.runs/DRAM3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DRAM3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DRAM3.tcl
