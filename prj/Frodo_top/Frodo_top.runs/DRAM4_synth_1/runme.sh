...
HD_PWD='C:/Users/Lenovo/Desktop/Frodo/prj/Frodo_top/Frodo_top.runs/DRAM4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DRAM4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DRAM4.tcl
