...
HD_PWD='C:/Users/Lenovo/Desktop/Frodo/prj/Frodo_top/Frodo_top.runs/uinst_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uinst_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uinst_rom.tcl
