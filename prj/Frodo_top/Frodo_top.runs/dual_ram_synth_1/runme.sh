...
HD_PWD='C:/Users/Lenovo/Desktop/Frodo/prj/Frodo_top/Frodo_top.runs/dual_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_ram.tcl
