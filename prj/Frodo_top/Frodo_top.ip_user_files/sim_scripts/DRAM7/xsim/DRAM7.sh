...
#
# Script generated by Vivado on Mon May 12 11:20:12 +0800 2025
...
#
# Usage        : DRAM7.sh
#                DRAM7.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DRAM7.sh [-reset_run]
#                DRAM7.sh [-reset_log]
#                DRAM7.sh [-help]
#
...
# script info
echo -e "DRAM7.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DRAM7.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DRAM7 xil_defaultlib.DRAM7 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DRAM7 -key {Behavioral:sim_1:Functional:DRAM7} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DRAM7.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DRAM7.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DRAM7.sh [-help]\n\
Usage: DRAM7.sh [-step]\n\
Usage: DRAM7.sh [-lib_map_path]\n\
Usage: DRAM7.sh [-reset_run]\n\
Usage: DRAM7.sh [-reset_log]\n\
Usage: DRAM7.sh [-keep_index]\n\
Usage: DRAM7.sh [-noclean_files]\n\n\
