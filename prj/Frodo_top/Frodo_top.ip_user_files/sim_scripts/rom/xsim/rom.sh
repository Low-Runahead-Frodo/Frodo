...
#
# Script generated by Vivado on Fri May 23 16:02:41 +0800 2025
...
#
# Usage        : rom.sh
#                rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom.sh [-reset_run]
#                rom.sh [-reset_log]
#                rom.sh [-help]
#
...
# script info
echo -e "rom.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom xil_defaultlib.rom xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rom.wdb xsim.dir libdpi.so)
...
Usage: rom.sh [-reset_log]\n\
Usage: rom.sh [-keep_index]\n\
