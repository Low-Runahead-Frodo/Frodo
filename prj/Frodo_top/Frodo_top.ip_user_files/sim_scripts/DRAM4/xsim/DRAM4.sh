...
#
# Script generated by Vivado on Mon May 12 11:18:56 +0800 2025
...
#
# Usage        : DRAM4.sh
#                DRAM4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DRAM4.sh [-reset_run]
#                DRAM4.sh [-reset_log]
#                DRAM4.sh [-help]
#
...
# script info
echo -e "DRAM4.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DRAM4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DRAM4 xil_defaultlib.DRAM4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DRAM4 -key {Behavioral:sim_1:Functional:DRAM4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DRAM4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DRAM4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DRAM4.sh [-help]\n\
Usage: DRAM4.sh [-step]\n\
Usage: DRAM4.sh [-lib_map_path]\n\
Usage: DRAM4.sh [-reset_run]\n\
Usage: DRAM4.sh [-reset_log]\n\
Usage: DRAM4.sh [-keep_index]\n\
Usage: DRAM4.sh [-noclean_files]\n\n\
