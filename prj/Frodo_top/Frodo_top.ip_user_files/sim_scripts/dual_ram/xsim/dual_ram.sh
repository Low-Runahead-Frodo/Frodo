...
#
# Script generated by Vivado on Mon May 12 12:18:28 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dual_ram.sh
...
#
# Usage        : dual_ram.sh
#                dual_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dual_ram.sh [-reset_run]
#                dual_ram.sh [-reset_log]
#                dual_ram.sh [-help]
#
...
# script info
echo -e "dual_ram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dual_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dual_ram xil_defaultlib.dual_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dual_ram -key {Behavioral:sim_1:Functional:dual_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dual_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dual_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dual_ram.sh [-help]\n\
Usage: dual_ram.sh [-step]\n\
Usage: dual_ram.sh [-lib_map_path]\n\
Usage: dual_ram.sh [-reset_run]\n\
Usage: dual_ram.sh [-reset_log]\n\
Usage: dual_ram.sh [-keep_index]\n\
Usage: dual_ram.sh [-noclean_files]\n\n\
