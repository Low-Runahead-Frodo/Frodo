...
#
# Script generated by Vivado on Fri May 23 16:11:38 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : uinst_rom.sh
...
#
# Usage        : uinst_rom.sh
#                uinst_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uinst_rom.sh [-reset_run]
#                uinst_rom.sh [-reset_log]
#                uinst_rom.sh [-help]
#
...
# script info
echo -e "uinst_rom.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uinst_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uinst_rom xil_defaultlib.uinst_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uinst_rom -key {Behavioral:sim_1:Functional:uinst_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb uinst_rom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uinst_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uinst_rom.sh [-help]\n\
Usage: uinst_rom.sh [-step]\n\
Usage: uinst_rom.sh [-lib_map_path]\n\
Usage: uinst_rom.sh [-reset_run]\n\
Usage: uinst_rom.sh [-reset_log]\n\
Usage: uinst_rom.sh [-keep_index]\n\
Usage: uinst_rom.sh [-noclean_files]\n\n\
